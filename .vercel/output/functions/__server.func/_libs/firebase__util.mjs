...
export {
  ...
  getDefaultEmulatorHostnameAndPort as c,
  deepEqual as d,
  ...
  getUA as j,
  getDefaultEmulatorHost as k,
  extractQuerystring as l,
  base64Decode as m,
  querystring as n,
  isMobileCordova as o,
  pingServer as p,
  querystringDecode as q,
  isReactNative as r,
  isBrowserExtension as s,
  isCloudflareWorker as t,
  createSubscribe as u,
