...
import { y as defineHandlerCallback, z as resolveManifestAssetLink, A as resolveManifestCssLink, C as rootRouteId, D as getNormalizedURL, E as getOrigin, F as normalizeSsrResponse, G as attachRouterServerSsrUtils, H as createSerializationAdapter, I as createRawStreamRPCPlugin, J as invariant, K as isNotFound, L as isRedirect, M as isResolvedRedirect, N as replaceSsrResponse, O as mergeHeaders, P as executeRewriteInput, Q as stripSsrResponseBody, S as defaultSerovalPlugins, T as makeSerovalPlugin, U as getScriptPreloadAttrs, V as getStylesheetHref, W as isSsrResponse } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B6EmFt9L.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-8iYk_PDV.mjs").then((n) => n.r),
    import("./start-BeuS9uqY.mjs"),
