...
export function themeColors(theme: "light" | "dark") {
  ...
  return {
    ...
    // Use these for text that sits directly ON the page background (blue in light mode)
    textOnBg:       dark ? "#FFFFFF"                       : "#FFFFFF",
    textMutedOnBg:  dark ? "#8A9BB5"                       : "rgba(255,255,255,0.75)",
    accentCyan:     dark ? "#38BDF8"                       : "#1E6FDB",
    ...
    navActive:      dark ? "#FFFFFF"                       : "#1648B0",
    navInactive:    dark ? "#8A9BB5"                       : "#9CA3AF",
    gradientBtn:    dark
      ? "linear-gradient(135deg, #0EA5E9, #6366F1)"
      : "linear-gradient(135deg, #1648B0, #4F46E5)",
