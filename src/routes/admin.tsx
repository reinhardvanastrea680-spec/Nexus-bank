...
function AdminLayout() {
  ...
  return (
    <div className="h-screen flex overflow-hidden">
      ...
      {/* Sidebar — fixed, always visible on desktop, scrolls internally */}
      <aside
      ...
      {/* Main content — sidebar stays fixed, this area scrolls */}
      <div className={`flex flex-col flex-1 transition-all min-w-0 ${sidebarCollapsed ? "lg:ml-0" : "lg:ml-[260px]"} ml-0 h-screen`}>
        {/* Header */}
